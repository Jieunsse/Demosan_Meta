...
export default function LaunchStatusPanel({ mutation, onNext }: Props) {
  ...
  if (launched) return <LaunchSuccessCard onNext={onNext} />;
  ...
  if (mutation.isError) {
    return (
      ...
      >
        ...
        <p style={{ font: "500 12.5px/1.5 var(--w-font-sans)", color: "var(--w-fg-neutral)", margin: 0 }}>
  ...
  return (
    <div className="card" style={{ textAlign: "center", padding: "32px 20px" }}>
      ...
      <p style={{ font: "500 12.5px/1.55 var(--w-font-sans)", color: "var(--w-fg-neutral)", margin: "8px 0 0" }}>
