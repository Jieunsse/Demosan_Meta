  ...
  return (
    ...
    >
      ...
      <div className="col-span-7 flex flex-col gap-4">
        <Panel title="한눈에 보는 브랜드 정체성" nested>
        ...
        <Panel title="근거 자료" icon="chart" count={proofPoints.length} nested>
      ...
      <div className="col-span-5 flex flex-col gap-4">
        <Panel title="브랜드 설명" icon="doc" nested>
          {description ? (
        ...
        <Panel title="고객 목소리 요약" icon="message" nested>
          {customerVoice ? (
        ...
        <Panel title="카피 레퍼런스" icon="copy" count={refs.length} nested>
          {refs.length === 0 ? (
            <EmptyState
